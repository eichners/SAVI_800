...
// this variable has these parameters: L.geoJson data (null for now),
// style info
// lot click info.
// should have: .change function results as a parameter
...
// CHANGE FUNCTION
var  lotChange = function addDataToMap(dataLayer, choice) {
...
console.log('anything');
   ...
   //map.fitBounds(addDataToMap.getBounds());
}); 
//NYBBgeoJSON.addTo(map);
